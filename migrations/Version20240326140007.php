 ...
 */
final class Version20240326140007 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        , CONSTRAINT FK_906517448F93B6FC FOREIGN KEY (movie_id) REFERENCES movie (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE)');
